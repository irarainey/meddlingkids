...
- **Server `main.py` split into separate modules** — API route handlers and request models have been extracted into `server/src/routes.py`. `main.py` now contains only the app factory, middleware wiring, lifespan management, and static-file serving, following the single-responsibility principle.
