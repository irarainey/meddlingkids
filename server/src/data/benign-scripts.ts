/**
 * @fileoverview Database of known benign scripts.
 * These scripts don't collect user data and should skip LLM analysis.
 */

import type { ScriptPattern } from './tracking-scripts.js'

/**
 * Benign scripts that don't collect user data - skip LLM analysis for these.
 * We'll give them a simple description and move on.
 */
export const BENIGN_SCRIPTS: ScriptPattern[] = [
