...
def _get_partner_domain_index() -> dict[str, dict[str, str | None]]:
    ...
    # Import lazily to avoid reference before PARTNER_CATEGORIES
    # is defined (this function is only called after module load).
    for cfg in PARTNER_CATEGORIES:
        db = get_partner_database(cfg.file)
