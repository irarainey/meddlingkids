...
// ============================================================================
// Composable — graph data computation
// ============================================================================
...
const {
  ...
  networkRequests: toRef(props, 'networkRequests'),
  structuredReport: toRef(props, 'structuredReport'),
  analyzedUrl: toRef(props, 'analyzedUrl'),
  viewMode,
  activeCategory,
  selectedNode,
})
